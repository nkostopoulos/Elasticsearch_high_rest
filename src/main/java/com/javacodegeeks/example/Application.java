...
public class Application
{
	...
	//9200 is used by the ES query server, this queries the ES engine through the RESTful APIs
	//9201 is used by the REST Server with which external clients can connect.
